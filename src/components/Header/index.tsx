          ...
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4   ">
              ...
              >
                {pathUrl !== "/" ? (
                  <>
                    <Image
                      src={`https://public-assets.fotoprohub.net/3.svg`}
                      alt="logo"
                      width={240}
                      height={30}
                  ...
                  <>
                    <Image
                      src={`${
                        sticky
                          ? "https://public-assets.fotoprohub.net/3.svg"
                          : "https://public-assets.fotoprohub.net/3.svg"
                      }`}
                      alt="logo"
                      width={140}
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <div
                  className="flex items-center gap-4 lg:gap-4 lg:pr-0"
                >
                  <Link
                    href="https://app.fotoprohub.net/login"
                    className="rounded-lg bg-white px-7 py-3 text-base font-medium text-dark
                    duration-300   ease-in-out hover:bg-white/90 hover:opacity-70 dark:text-white     dark:hover:bg-white/20
                    "
                  >
                    Sign In
                  </Link>
                  <Link
                    href="https://app.fotoprohub.net/register"
                    className="rounded-lg bg-dark px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-dark/90 dark:bg-white/10 dark:hover:bg-white/20"
                  >
                    Sign Up
                  </Link>
                </div>
