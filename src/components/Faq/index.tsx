      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What is Fotoprohub?"
              answer="Fotoprohub is a platform designed specifically for photographers to showcase their portfolios, connect with clients, and grow their businesses."
            />
            <SingleFaq
              question="How do I create a portfolio on Fotoprohub?"
              answer="Simply sign up for an account, upload your photos, and organize them into collections. You can customize your portfolio's layout and design to fit your brand."
            />
            <SingleFaq
              question="Can I use Fotoprohub for free?"
              answer="Yes! Fotoprohub offers a free plan with limited of features. We also offer premium plans with additional features and support."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How do I get more visibility for my portfolio?"
              answer="Fotoprohub has a built-in discovery feature that allows potential clients to find you. You can also share your portfolio on social media and use our SEO optimization tools."
            />
            <SingleFaq
              question="How do I get started?"
              answer="Sign up for free, create a profile, and start exploring or showcasing your photos!"
            />
            <SingleFaq
              question="What kind of support does Fotoprohub offer?"
              answer="Our support team is available 24/7 to help with any questions or issues you may have. We also offer tutorials and guides to help you get the most out of our platform."
            />
          </div>
        </div>
      </div>
